    ...
    <div className="flex flex-col py-10 mx-auto antialiased items-center space-y-6 bg-linear-to-b from-rose-100 to-rose-100/5 ">
      <div className="flex flex-row  items-center space-x-5  rounded-xl ">
        ...
        <div className='flex flex-col'>
          <p className="text-3xl font-bold text-rose-700">{params.message ? params.message : t('errorUI.defaultMessage')}</p>
      ...
      <div className='flex space-x-4'>
        ...
        >
          ...
          <span className="text-md font-bold">{t('errorUI.retry')}</span>
        </button>
        <Link
        ...
        >
          ...
          <span className="text-md font-bold">{t('errorUI.home')}</span>
        </Link>
      </div>
    </div>
  )
